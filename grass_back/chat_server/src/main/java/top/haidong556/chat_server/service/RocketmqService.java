...
public class RocketmqService implements Runnable{
    ...
    private RocketmqService(){
        ...
        try {
            consumer.subscribe(MyConfiguration.ROCKETMQ_TOPIC, MyConfiguration.ROCKETMQ_CHAT_MESSAGE_TAG_PREFIX+MyConfiguration.MYSELF_CHAT_SERVER_ID);
