...
class HttpVerificationFilterTest {
    static HttpVerificationFilter httpVerificationFilter;
    static String jwt;
    @BeforeAll
    static void init(){
        httpVerificationFilter =new HttpVerificationFilter();
    ...
    void verifyAndGetMessage() {
        httpVerificationFilter.verifyAndGetMessage(jwt);
    }
}